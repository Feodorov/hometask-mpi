...
<head>
 ...
 var codesite_token = "A2gsfidAvAOe3-05Jc9ucevQgLI:1343107240936";
 
 
 var CS_env = {"profileUrl":["/u/117547682639956396526/"],"token":"A2gsfidAvAOe3-05Jc9ucevQgLI:1343107240936","assetHostPath":"http://www.gstatic.com/codesite/ph","domainName":null,"assetVersionPath":"http://www.gstatic.com/codesite/ph/13293733053503680815","projectHomeUrl":"/p/hpcource","relativeBaseUrl":"","projectName":"hpcource","loggedInUserEmail":"K.A.Feodorov@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fhpcource%2Fsource%2Fbrowse%2Ftrunk%2Fcsc%2Ffka%2F2%2Fmpi_hometask%2Fmain.cpp" 
...
<table id="nav_and_rev" class="list"
 ...
 <a href="/p/hpcource/source/browse/trunk/csc/fka/2/mpi_hometask/main.cpp?edit=1"
 ...
 <li><a href="/p/hpcource/source/browse/trunk/csc/fka/2/mpi_hometask/main.cpp?r=2624" title="Previous">&lsaquo;r2624</a></li>
...
><td class="source">#include &lt;omp.h&gt;<br></td></tr
><tr
id=sl_svn2899_6
...
><td class="source">#define INTEGRAL_ITER	10<br></td></tr
><tr
id=sl_svn2899_9
...
><td class="source">typedef double (* get_integral_value) (double, int);<br></td></tr
><tr
id=sl_svn2899_12

 onmouseover="gutterOver(12)"

><td class="source">typedef std::map&lt;int, MPI_Request*&gt; request_map_t;<br></td></tr
><tr
id=sl_svn2899_13

 onmouseover="gutterOver(13)"

><td class="source">typedef std::pair&lt;int, MPI_Request *&gt; request_entry_t;<br></td></tr
><tr
id=sl_svn2899_14

 onmouseover="gutterOver(14)"

><td class="source">typedef std::map&lt;int, double *&gt; recvbuf_map_t;<br></td></tr
><tr
id=sl_svn2899_15

 onmouseover="gutterOver(15)"

><td class="source">typedef std::pair&lt;int, double *&gt; recvbuf_entry_t;<br></td></tr
><tr
id=sl_svn2899_16

 onmouseover="gutterOver(16)"

><td class="source">double get_integr_value(double x, int func_number)<br></td></tr
><tr
id=sl_svn2899_17
...
><td class="source">	double result = 0;<br></td></tr
><tr
id=sl_svn2899_19

 onmouseover="gutterOver(19)"

><td class="source">	//No need to omp parallel for, because this code is called from &quot;omp parallel for&quot; in integrateFunc<br></td></tr
><tr
id=sl_svn2899_20

 onmouseover="gutterOver(20)"

><td class="source">	for(int i = 0; i &lt; func_number; ++i)<br></td></tr
><tr
id=sl_svn2899_21
...
><td class="source">		result += sin(x); <br></td></tr
><tr
id=sl_svn2899_23
...
><td class="source">double integrate(double left_limit, double right_limit, int func_number, get_integral_value func)<br></td></tr
><tr
id=sl_svn2899_29
...
><td class="source">	double step = (right_limit - left_limit) / INTEGRAL_ITER;<br></td></tr
><tr
id=sl_svn2899_32
...
><td class="source">#pragma omp parallel for reduction(+:result) <br></td></tr
><tr
id=sl_svn2899_34

 onmouseover="gutterOver(34)"

><td class="source">	for (int i = 0; i &lt;= INTEGRAL_ITER; i++) <br></td></tr
><tr
id=sl_svn2899_35
...
><td class="source">		result += func(left_limit + step * i, func_number) * step ;<br></td></tr
><tr
id=sl_svn2899_37
...
><td class="source">	int rank, size;<br></td></tr
><tr
id=sl_svn2899_45

 onmouseover="gutterOver(45)"

><td class="source">	double count;<br></td></tr
><tr
id=sl_svn2899_46

 onmouseover="gutterOver(46)"

><td class="source">	double task[4]; <br></td></tr
><tr
id=sl_svn2899_47

 onmouseover="gutterOver(47)"

><td class="source">	int task_id = 0;<br></td></tr
><tr
id=sl_svn2899_48
...
><td class="source">	double * recvbuf;<br></td></tr
><tr
id=sl_svn2899_50

 onmouseover="gutterOver(50)"

><td class="source">	MPI_Request	* recv_requests;<br></td></tr
><tr
id=sl_svn2899_51
...
><td class="source">	recvbuf_map_t recvbuf_map;<br></td></tr
><tr
id=sl_svn2899_53

 onmouseover="gutterOver(53)"

><td class="source">	request_map_t recv_requests_map;<br></td></tr
><tr
id=sl_svn2899_54
...
><td class="source">	MPI_Comm_rank(MPI_COMM_WORLD,&amp;rank);<br></td></tr
><tr
id=sl_svn2899_57

 onmouseover="gutterOver(57)"

><td class="source">	MPI_Comm_size(MPI_COMM_WORLD,&amp;size);<br></td></tr
><tr
id=sl_svn2899_58
...
><td class="source">	if(0 == rank)<br></td></tr
><tr
id=sl_svn2899_60
...
><td class="source">			&quot;Input limits and the number of integrate functions: Input data format: left_limit right_limit func_num.&quot; &lt;&lt; std::endl &lt;&lt;<br></td></tr
><tr
id=sl_svn2899_63

 onmouseover="gutterOver(63)"

><td class="source">			&quot;Example: 4 1.5 2&quot; &lt;&lt; std::endl &lt;&lt;<br></td></tr
><tr
id=sl_svn2899_64
...
><td class="source">			std::cin.getline(input, sizeof(input));<br></td></tr
><tr
id=sl_svn2899_69
...
><td class="source">			if(!strcmp(input, &quot;quit&quot;))<br></td></tr
><tr
id=sl_svn2899_71
...
><td class="source">				task_id = -1;<br></td></tr
><tr
id=sl_svn2899_73
...
><td class="source">				sscanf_s(input, &quot;%lf %lf %lf&quot;, &amp;task[0], &amp;task[1], &amp;task[2]);<br></td></tr
><tr
id=sl_svn2899_77

 onmouseover="gutterOver(77)"

><td class="source">				std::cout &lt;&lt; &quot;Data for task &quot; &lt;&lt; task_id &lt;&lt; &quot;: &quot; &lt;&lt; task[0] &lt;&lt; &quot; &quot; &lt;&lt; task[1] &lt;&lt; &quot; &quot; &lt;&lt; task[2] &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn2899_78
...
><td class="source">			task[3] = task_id;<br></td></tr
><tr
id=sl_svn2899_81
...
><td class="source">			MPI_Bcast(task, 4, MPI_DOUBLE, 0, MPI_COMM_WORLD);<br></td></tr
><tr
id=sl_svn2899_83
...
><td class="source">			if( -1 == task_id)//quit<br></td></tr
><tr
id=sl_svn2899_85
...
><td class="source">				//wait for all results<br></td></tr
><tr
id=sl_svn2899_87

 onmouseover="gutterOver(87)"

><td class="source">				for(request_map_t::iterator it = recv_requests_map.begin(); it != recv_requests_map.end(); ++it)<br></td></tr
><tr
id=sl_svn2899_88
...
><td class="source">					MPI_Waitall(size - 1, it-&gt;second, MPI_STATUS_IGNORE);<br></td></tr
><tr
id=sl_svn2899_90
...
><td class="source">					for(int i = 1; i &lt; size; ++i)<br></td></tr
><tr
id=sl_svn2899_93

 onmouseover="gutterOver(93)"

><td class="source">						result += recvbuf_map[it-&gt;first][i];<br></td></tr
><tr
id=sl_svn2899_94

 onmouseover="gutterOver(94)"

><td class="source">					std::cout &lt;&lt; &quot;Result for task &quot; &lt;&lt; it-&gt;first &lt;&lt; &quot;: &quot; &lt;&lt; result &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn2899_95
...
><td class="source">				for(recvbuf_map_t::iterator iter = recvbuf_map.begin(); iter != recvbuf_map.end(); ++iter)<br></td></tr
><tr
id=sl_svn2899_101
...
><td class="source">			//prepair buffers for requests and results<br></td></tr
><tr
id=sl_svn2899_108

 onmouseover="gutterOver(108)"

><td class="source">			recvbuf = new double[size];<br></td></tr
><tr
id=sl_svn2899_109

 onmouseover="gutterOver(109)"

><td class="source">			recv_requests = new MPI_Request[size - 1];<br></td></tr
><tr
id=sl_svn2899_110
...
><td class="source">			recvbuf_map.insert(recvbuf_entry_t(task_id, recvbuf));<br></td></tr
><tr
id=sl_svn2899_112

 onmouseover="gutterOver(112)"

><td class="source">			recv_requests_map.insert(request_entry_t(task_id, recv_requests));<br></td></tr
><tr
id=sl_svn2899_113
...
><td class="source">			//send all tasks<br></td></tr
><tr
id=sl_svn2899_115
...
><td class="source">				MPI_Irecv(&amp;recvbuf[i], 1, MPI_DOUBLE, i, 1, MPI_COMM_WORLD, &amp;recv_requests[i-1]);<br></td></tr
><tr
id=sl_svn2899_117
...
><td class="source">			//check if any task is ready <br></td></tr
><tr
id=sl_svn2899_119

 onmouseover="gutterOver(119)"

><td class="source">			request_map_t::iterator it = recv_requests_map.begin();<br></td></tr
><tr
id=sl_svn2899_120

 onmouseover="gutterOver(120)"

><td class="source">			while(it != recv_requests_map.end())<br></td></tr
><tr
id=sl_svn2899_121
...
><td class="source">				MPI_Testall(size - 1, it-&gt;second, &amp;flag, MPI_STATUS_IGNORE);<br></td></tr
><tr
id=sl_svn2899_125
...
><td class="source">					int task = it-&gt;first;<br></td></tr
><tr
id=sl_svn2899_129
...
><td class="source">					//print result<br></td></tr
><tr
id=sl_svn2899_131
...
><td class="source">						result += recvbuf_map[task][i];<br></td></tr
><tr
id=sl_svn2899_134

 onmouseover="gutterOver(134)"

><td class="source">					std::cout &lt;&lt; &quot;Result for task &quot; &lt;&lt; task &lt;&lt; &quot;: &quot; &lt;&lt; result &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn2899_135
...
><td class="source">					//remove completed tasks<br></td></tr
><tr
id=sl_svn2899_137
...
><td class="source">					recv_requests_map.erase(it++);<br></td></tr
><tr
id=sl_svn2899_139
...
><td class="source">					recvbuf_map_t::iterator iter = recvbuf_map.find(task);<br></td></tr
><tr
id=sl_svn2899_141
...
><td class="source">					recvbuf_map.erase(iter);<br></td></tr
><tr
id=sl_svn2899_143
...
><td class="source">			task_id++;<br></td></tr
><tr
id=sl_svn2899_151
...
><td class="source">			if(-1 == task[3])<br></td></tr
><tr
id=sl_svn2899_160
...
><td class="source">				std::cout &lt;&lt; &quot;Process &quot; &lt;&lt; rank &lt;&lt; &quot; quit.&quot; &lt;&lt; std::endl; <br></td></tr
><tr
id=sl_svn2899_162
...
><td class="source">			//how many functions to calculate per node(based on user&#39;s input and available nodes)<br></td></tr
><tr
id=sl_svn2899_167

 onmouseover="gutterOver(167)"

><td class="source">			int amount = ((int)task[2] % (size - 1) ) ? ((int)task[2] / (size - 1)) : ((int)task[2] / (size - 1) + 1);<br></td></tr
><tr
id=sl_svn2899_168
...
><td class="source">			if(0 == amount)<br></td></tr
><tr
id=sl_svn2899_170

 onmouseover="gutterOver(170)"

><td class="source">				amount++;<br></td></tr
><tr
id=sl_svn2899_171
...
><td class="source">			//each node calculate &quot;amount&quot; number functions. Start value is based on node&#39;s rank<br></td></tr
><tr
id=sl_svn2899_175

 onmouseover="gutterOver(175)"

><td class="source">			for(int i = 0; i &lt; amount; ++i)<br></td></tr
><tr
id=sl_svn2899_176

 onmouseover="gutterOver(176)"

><td class="source">				if((rank - 1)*amount + i &lt; task[2])<br></td></tr
><tr
id=sl_svn2899_177

 onmouseover="gutterOver(177)"

><td class="source">					count += integrate(task[0], task[1], (rank - 1)*amount + i + 1, get_integr_value);<br></td></tr
><tr
id=sl_svn2899_178
...
><td class="source">			MPI_Send(&amp;count, 1, MPI_DOUBLE, 0, 1, MPI_COMM_WORLD);<br></td></tr
><tr
id=sl_svn2899_180

 onmouseover="gutterOver(180)"

><td class="source">			std::cout &lt;&lt; &quot;Process &quot; &lt;&lt; rank &lt;&lt; &quot;: send result for task_id: &quot; &lt;&lt; task[3] &lt;&lt;  &quot;. Result: &quot; &lt;&lt; count &lt;&lt; std::endl;<br></td></tr
><tr
id=sl_svn2899_181
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/hpcource/source/detail?spec=svn2899&amp;r=2705">r2705</a>
 by k.a.feodorov@gmail.com
 on May 15, 2012
 &nbsp; <a href="/p/hpcource/source/diff?spec=svn2899&r=2705&amp;format=side&amp;path=/trunk/csc/fka/2/mpi_hometask/main.cpp&amp;old_path=/trunk/csc/fka/2/mpi_hometask/main.cpp&amp;old=2624">Diff</a>
 </div>
 <pre>Issues for previous revision are fixed</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/hpcource/source/detail?r=2705&spec=svn2899';
 var publish_url = '/p/hpcource/source/detail?r=2705&spec=svn2899#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/csc/fka/2/mpi_hometask/main.cpp');
 changed_urls.push('/p/hpcource/source/browse/trunk/csc/fka/2/mpi_hometask/main.cpp?r\x3d2705\x26spec\x3dsvn2899');
 
 var selected_path = '/trunk/csc/fka/2/mpi_hometask/main.cpp';
 ...
 <option value="/p/hpcource/source/browse/trunk/csc/fka/2/mpi_hometask/main.cpp?r=2705&amp;spec=svn2899"
 selected="selected"
 >.../csc/fka/2/mpi_hometask/main.cpp</option>
 ...
 <a class="ifOpened" href="/p/hpcource/source/detail?r=2705&spec=svn2899#publish">Publish your comments</a>
 ...
 <a href="/p/hpcource/source/detail?spec=svn2899&r=2624">r2624</a>
 by K.A.Feodorov@gmail.com
 on Apr 21, 2012
 &nbsp; <a href="/p/hpcource/source/diff?spec=svn2899&r=2624&amp;format=side&amp;path=/trunk/csc/fka/2/mpi_hometask/main.cpp&amp;old_path=/trunk/csc/fka/2/mpi_hometask/main.cpp&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">На проверку</pre>
 </div>
 
 
 <a href="/p/hpcource/source/list?path=/trunk/csc/fka/2/mpi_hometask/main.cpp&start=2705">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//hpcource.googlecode.com/svn/trunk/csc/fka/2/mpi_hometask/main.cpp">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn2899': '/trunk/csc/fka/2/mpi_hometask/main.cpp'}
